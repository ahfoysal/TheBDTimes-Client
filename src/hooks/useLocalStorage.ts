...
function usepewdsflixSettings() {
  const currentSubtitleFontColor = useLocalStorageValue(
    'pewdsflix_settings-subtitle-font_color',
    {
      defaultValue: 'White',
    }
  );
  const currentSubtitleFontSize = useLocalStorageValue(
    'pewdsflix_settings-subtitle-font_size',
    {
      defaultValue: '100%',
    }
  );
  ...
  const autoShowSubtitle = useLocalStorageValue(
    'pewdsflix_settings-subtitle-auto_show',
    {
      defaultValue: false,
    }
  );
  ...
  // });
  const isMutedTrailer = useLocalStorageValue(
    'pewdsflix_settings-list-mute_trailer',
    {
      defaultValue: true,
      initializeWithValue: false,
    }
  );
  const isPlayTrailer = useLocalStorageValue(
    'pewdsflix_settings-list-play_trailer',
    {
      defaultValue: false,
      initializeWithValue: false,
    }
  );
  const isFetchLogo = useLocalStorageValue(
    'pewdsflix_settings-list-fetch_logo',
    {
      defaultValue: false,
    }
  );
  const isShowSpotlight = useLocalStorageValue(
    'pewdsflix_settings-list-show_spotlight',
    {
      defaultValue: false,
    }
  );
  const isAutoSize = useLocalStorageValue(
    'pewdsflix_settings-player-auto_size',
    {
      defaultValue: false,
    }
  );
  const isPicInPic = useLocalStorageValue(
    'pewdsflix_settings-player-pic_in_pic',
    {
      defaultValue: true,
    }
  );
  ...
  const isAutoPlay = useLocalStorageValue(
    'pewdsflix_settings-player-auto_play',
    {
      defaultValue: false,
    }
  );
  const isAutoMini = useLocalStorageValue(
    'pewdsflix_settings-player-auto_mini',
    {
      defaultValue: false,
    }
  );
  ...
  const isScreenshot = useLocalStorageValue(
    'pewdsflix_settings-player-screenshot',
    {
      defaultValue: true,
    }
  );
  const isMiniProgressBar = useLocalStorageValue(
    'pewdsflix_settings-player-mini_progress_bar',
    {
      defaultValue: true,
    }
  );
  const isAutoPlayback = useLocalStorageValue(
    'pewdsflix_settings-player-auto_playback',
    {
      defaultValue: true,
    }
  );
  ...
  const isAutoSkipOpEd = useLocalStorageValue(
    'pewdsflix_settings-player-auto_skip_op_ed',
    {
      defaultValue: false,
    }
  );
  const isFastForward = useLocalStorageValue(
    'pewdsflix_settings-player-fast_forward',
    {
      defaultValue: true,
    }
  );
  ...
  const sidebarStyleMode = useLocalStorageValue(
    'pewdsflix_settings-layout-sidebar-style_mode',
    {
      defaultValue: 'rounded-all',
    }
  );
  const sidebarMiniMode = useLocalStorageValue(
    'pewdsflix_settings-layout-sidebar-mini_mode',
    {
      defaultValue: false,
      initializeWithValue: false,
    }
  ...
  const sidebarHoverMode = useLocalStorageValue(
    'pewdsflix_settings-layout-sidebar-hover_mode',
    {
      defaultValue: false,
      initializeWithValue: false,
    }
  ...
  const sidebarBoxedMode = useLocalStorageValue(
    'pewdsflix_settings-layout-sidebar-boxed_mode',
    {
      defaultValue: false,
      initializeWithValue: false,
    }
  ...
  const sidebarSheetMode = useLocalStorageValue(
    'pewdsflix_settings-layout-sidebar-sheet_mode',
    {
      defaultValue: false,
      initializeWithValue: false,
    }
  ...
  const listLoadingType = useLocalStorageValue(
    'pewdsflix_settings-layout-list-loading_type',
    {
      defaultValue: 'pagination',
      initializeWithValue: false,
    }
  );
  const autoSwitchSubtitle = useLocalStorageValue(
    'pewdsflix_settings-subtitle-auto_switch',
    {
      defaultValue: true,
    }
  );
  ...
  const currentThemeColor = useLocalStorageValue(
    'pewdsflix_settings-layout-theme-color',
    {
      defaultValue: 'blue',
      initializeWithValue: false,
    }
